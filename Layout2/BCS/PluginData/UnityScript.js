...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v1.5.5_Transport.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v1.5.5_Transport.data.unityweb",
  frameworkUrl: buildUrl + "/v1.5.5_Transport.framework.js.unityweb",


  codeUrl: buildUrl + "/v1.5.5_Transport.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-Transport",
  productVersion: "v1.5.5",
