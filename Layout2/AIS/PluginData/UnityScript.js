...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v1.0.24_CT.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v1.0.24_CT.data.unityweb",
  frameworkUrl: buildUrl + "/v1.0.24_CT.framework.js.unityweb",


  codeUrl: buildUrl + "/v1.0.24_CT.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-CT",
