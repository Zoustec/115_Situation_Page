...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v25.4.4_Freezer.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v25.4.4_Freezer.data.unityweb",
  frameworkUrl: buildUrl + "/v25.4.4_Freezer.framework.js.unityweb",


  codeUrl: buildUrl + "/v25.4.4_Freezer.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-Freezer",
  productVersion: "v25.4.4",
