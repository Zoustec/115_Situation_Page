...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v1.0.16_RSM.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v1.0.16_RSM.data.unityweb",
  frameworkUrl: buildUrl + "/v1.0.16_RSM.framework.js.unityweb",


  codeUrl: buildUrl + "/v1.0.16_RSM.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-RSM",
  productVersion: "v1.0.16",
