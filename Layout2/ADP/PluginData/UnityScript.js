...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v2.3.2_Pipet.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v2.3.2_Pipet.data.unityweb",
  frameworkUrl: buildUrl + "/v2.3.2_Pipet.framework.js.unityweb",


  codeUrl: buildUrl + "/v2.3.2_Pipet.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-Pipet",
  productVersion: "v2.3.2",
