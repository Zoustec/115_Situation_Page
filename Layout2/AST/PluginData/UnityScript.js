...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v1.0.24_IOM.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v1.0.24_IOM.data.unityweb",
  frameworkUrl: buildUrl + "/v1.0.24_IOM.framework.js.unityweb",


  codeUrl: buildUrl + "/v1.0.24_IOM.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-IOM",
  productVersion: "v1.0.24",
