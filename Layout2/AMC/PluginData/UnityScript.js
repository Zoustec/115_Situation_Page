...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/v1.0.15_CM.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/v1.0.15_CM.data.unityweb",
  frameworkUrl: buildUrl + "/v1.0.15_CM.framework.js.unityweb",


  codeUrl: buildUrl + "/v1.0.15_CM.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec Ltd.",
  productName: "drsignal-CM",
  productVersion: "v1.0.15",
