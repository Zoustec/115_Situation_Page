...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/Situation.loader.js";
var config = {
  arguments: [],
  dataUrl: buildUrl + "/Situation.data.unityweb",
  frameworkUrl: buildUrl + "/Situation.framework.js.unityweb",


  codeUrl: buildUrl + "/Situation.wasm.unityweb",



  streamingAssetsUrl: "StreamingAssets",
  companyName: "Zoustec",
  productName: "114_Situation",
